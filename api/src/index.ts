...
import { migrationVerifyRouter } from "./routes/migration-verify-router";

//import { configureLocalAuthentication } from "./routes/auth-local";
import { RequiresData, SanitizeNulls } from "./middleware";
...
app.use("/api/migration-verify", RequiresData, migrationVerifyRouter);
