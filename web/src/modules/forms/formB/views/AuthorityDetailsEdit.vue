                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="3" rowspan="2">
                                            OTHER:<br />S.24 COMMITMENT &
                                            <br />S.23 SIGNING CONTRACT
                                        </th>
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="4" class="rotate">
                                            <div>
                                                S.23 Signing<br />contract
                                            </div>
                                        </th>
                                        <th rowspan="4" class="rotate">
                                            <div>
                                                S.24 Travel <br />authorization
                                            </div>
                                        </th>
                                        <th rowspan="4" class="rotate">
                                            <div>
                                    ...
                                    <tr style="height: 30px">
                                        <th style="height: 30px">
                                            Area of Authority - General Ledger
                                            Coding
                                        </th>
                                        <th style="height: 30px">
...
export default {
    ...
    computed: {
        ...
        breadcrumbs: function () {
            ...
            b.push({
                text: `Form B (${this.formB.department_descr} - ${this.formB.program_branch})`,
